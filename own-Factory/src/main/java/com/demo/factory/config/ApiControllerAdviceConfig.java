...
import com.demo.factory.utils.AtomicCounter;
...
@Component
@Aspect
public class ApiControllerAdviceConfig {
    private static final Logger logger = LoggerFactory.getLogger(ApiControllerAdviceConfig.class);
    private ThreadLocal<Long> startTime = new ThreadLocal<>();
    //aop 扫描下所有接口都会被统计   切面表达式
    @Pointcut("execution(* com.demo.factory.controller..UserController.getUserInfo(..))")
